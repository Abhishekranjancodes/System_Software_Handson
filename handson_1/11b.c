...
int main(){
	...
	const char* temp = "I am writing using newfd created using dup2\n";
...
oldfish@oldfish-Katana-GF66-12UC:~/Desktop/Term 1/Linux_call/handson$ cc 11b.c
...
I am writing using newfd created using dup2
